...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents textfiletoparsetxt As System.Windows.Forms.TextBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.textfiletoparsetxt = New System.Windows.Forms.TextBox
        ...
        Me.Panel1.Controls.Add(Me.textfiletoparsetxt)
        ...
        'textfiletoparsetxt
        '
        Me.textfiletoparsetxt.BackColor = System.Drawing.Color.White
        Me.textfiletoparsetxt.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle
        Me.textfiletoparsetxt.ForeColor = System.Drawing.Color.Purple
        Me.textfiletoparsetxt.Location = New System.Drawing.Point(16, 64)
        Me.textfiletoparsetxt.Name = "textfiletoparsetxt"
        Me.textfiletoparsetxt.ReadOnly = True
        Me.textfiletoparsetxt.Size = New System.Drawing.Size(360, 20)
        Me.textfiletoparsetxt.TabIndex = 59
        Me.textfiletoparsetxt.Text = ""
        '
        'Label14
        '
        ...
        Me.Label14.Text = "INPUT MULTI-LINE TEXT FILE"
        ...
        Me.CheckBox1.ForeColor = System.Drawing.Color.Purple
        ...
        Me.filefoldertxt.ForeColor = System.Drawing.Color.Purple
        ...
        'label22
        '
        Me.label22.BackColor = System.Drawing.Color.Purple
        ...
        Me.Label23.Size = New System.Drawing.Size(256, 16)
        ...
        Me.Label9.Location = New System.Drawing.Point(320, 0)
        Me.Label9.Name = "Label9"
        Me.Label9.Size = New System.Drawing.Size(109, 8)
        Me.Label9.TabIndex = 54
        Me.Label9.Text = "BUILD 20060306.1"
        ...
        Me.Label4.Text = "Select the folder whose files you wish to rename, select the multi-line input tex" & _
        "t file that contains the new filenames and click on the Proceed button to contin" & _
        "ue."
        '
        'OpenFileDialog1
        '
        Me.OpenFileDialog1.DefaultExt = "txt"
        Me.OpenFileDialog1.Filter = "*.*|All text files"
        ...
        Me.Text = "Input File Based Renamer"
...
#End Region
    ...
    Private textfiletoparse As String
    ...
    Private Sub Error_Handler(ByVal ex As Exception, Optional ByVal identifier_msg As String = "")
        ...
        Catch exc As Exception
            MsgBox("An error occurred in Input File Based Renamer's error handling routine. The application will try to recover from this serious error.", MsgBoxStyle.Critical, "Critical Error Encountered")
        End Try
    End Sub
    ...
    Public Sub Load_Registry_Values()
        Try
            ...
            For Each str In keys
                If str.Equals("Software\Input File Based Renamer") = True Then
                    keyflag1 = True
                    Exit For
                End If
            Next str
            ...
            If keyflag1 = False Then
                oReg.CreateSubKey("Software\Input File Based Renamer")
            End If

            keyflag1 = False

            Dim oKey As RegistryKey = oReg.OpenSubKey("Software\Input File Based Renamer", True)
            ...
            str = oKey.GetValue("textfiletoparse")
            If Not IsNothing(str) And Not (str = "") Then
                textfiletoparse = str
            Else
                configflag = True
                oKey.SetValue("textfiletoparse", "")
                textfiletoparse = ""
            End If
            textfiletoparsetxt.Text = textfiletoparse
    ...
    Private Sub Save_Registry_Values()
        Try
            ...
            oKey.SetValue("textfiletoparse", textfiletoparsetxt.Text)
    ...
    Private Sub run_worker()
        ...
        Worker1.textfiletoparse = textfiletoparsetxt.Text
    ...
    Private Sub force_check()
        Try
            ...
            If currently_working = False Then
                If ((Not textfiletoparsetxt.Text = "") And (Not filefoldertxt.Text = "")) Then
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            If Not textfiletoparsetxt.Text = "" Then
                OpenFileDialog1.FileName = textfiletoparsetxt.Text
            End If
            Dim result As DialogResult = OpenFileDialog1.ShowDialog()
            If Not result = DialogResult.Cancel Then
                textfiletoparsetxt.Text = OpenFileDialog1.FileName
                textfiletoparse = OpenFileDialog1.FileName
            End If
    ...
    'Private Sub textfiletoparsetxt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles textfiletoparsetxt.TextChanged
    '    If textfiletoparsetxt.Text.Length > 0 Then
